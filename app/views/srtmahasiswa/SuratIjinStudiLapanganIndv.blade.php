...
<body>
	...
	<table style="align:center;" width=700px class="Myriad">
		<tr>
			<td width=8%></td>
			<td width=90% style="text-align:justify;">Dalam rangka memenuhi tugas mata kuliah {{$datas->mata_kuliah}} yang dibimbing oleh {{$datas->pembimbing}} bersama ini kami hadapkan mahasiswa:</td>
			<td width=8%></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
